...
?>
<?php
$query1=mysqli_query($conn,"select * from salary");
?>
<?php
$query2=mysqli_query($conn,"select * from hour");
mysqli_data_seek($query, 0); // Reset pointer to beginning
mysqli_data_seek($query1, 0); 
mysqli_data_seek($query2, 0);// Reset pointer to beginning
...
<html lang="en">
  ...
  <body>
      ...
      <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
          <a class="navbar-brand" href="index.html">Student Job Portal</a>
          ...
          <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item cta cta-colored"><a href="job_post.php" class="nav-link">Want a Job</a></li>
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('images/bg_20.png');" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-xl-10 ftco-animate mb-5 pb-5" data-scrollax=" properties: { translateY: '70%' }">
            <p class="mb-4 mt-5 pt-5" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">We have <span class="number" data-number="850000">0</span> great job offers you deserve!</p>
            <h1 class="mb-5" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Opening Doors to <br><span>Student Opportunities</span></h1>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <div class="form-field">
                                                ...
                                                <input type="text" name="keyword" id="key" class="form-control" placeholder="eg. Graphic. Web Developer">
                                              </div>
                                          </div>
                                    </div>
                                    <div class="form-group">
        ...
        <div class="form-field">
            <div class="select-wrap">
                ...
                <select name="hour" id="hour" class="form-control">
                    ...
                    <?php
                    while($hour_row=mysqli_fetch_array($query2)){?>
                        <option value="<?php echo $hour_row['id'];?>"><?php echo $hour_row['hour'];?></option>
                    <?php
                    }
                    ?>
                </select>
...
<div class="col-md">
    <div class="form-group">
        <div class="form-field">
            <div class="select-wrap">
                <div class="icon"><span class="ion-ios-arrow-down"></span></div>
                <select name="salary" id="salary_range" class="form-control">
    <option value="">Salary/hour</option>
    <?php
    mysqli_data_seek($query1, 0); // Reset pointer to beginning
    while ($salary_row = mysqli_fetch_array($query1)) { ?>
        <option value="<?php echo $salary_row['id']; ?>"><?php echo $salary_row['salary_range']; ?></option>
    <?php
    }
    ?>
</select>
...
$sql = null; // Initialize $sql variable
// if (isset($_SESSION['search_performed'])) {
  if (isset($_POST['search'])) {
    $keyword = '%' . $_POST['keyword'] . '%'; // Append '%' to keyword
    $category = $_POST['category'];
    $hour = $_POST['hour'];
    $salary_range = $_POST['salary'];

    // Base SQL query
    $sql1 = "SELECT * FROM all_jobs LEFT JOIN company ON all_jobs.customer_email = company.admin WHERE 1";
    ...
    if (!empty($conditions)) {
        ...
        $sql1 .= " AND ($where_clause)";
    }

    // Prepare the SQL statement
    $stmt = $conn->prepare($sql1);

    // Determine parameter types and values
    $param_types = ''; // Initialize parameter types string
    $params = array(); // Initialize params array
    
    // Add parameter types and values for non-empty POST parameters
    if (!empty($keyword)) {
        $param_types .= 's'; // Add parameter type for string
        $params[] = $keyword; // Add parameter value
    }
    if (!empty($category)) {
        $param_types .= 's'; // Add parameter type for string
        $params[] = $category; // Add parameter value
    }
    if (!empty($hour)) {
        $param_types .= 's'; // Add parameter type for string
        $params[] = $hour; // Add parameter value
    }
    if (!empty($salary_range)) {
        $param_types .= 's'; // Add parameter type for string
        $params[] = $salary_range; // Add parameter value
    }
    ...
    <div class="container">
        ...
        <div class="row">
                            ...
                            <div class="mb-4 mb-md-0 mr-5">
                                <div class="job-post-item-header d-flex align-items-center">
                                    ...
                                    <div class="badge-wrap">
                                        <span class="bg-primary text-white badge py-2 px-3"><?php echo $row['company'];?></span>
                                    </div>
                                </div>
            ...
            <?php
                ...
                echo "No results found"; // Inform the user if there are no results
            }
            ?>
        </div>
    </div>
